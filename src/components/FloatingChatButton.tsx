        ...
        <div className="fixed bottom-6 right-6 z-[100]">
            ...
            >
                <button
                    ...
                    className="relative group p-4 bg-black text-white rounded-full shadow-[0_10px_40px_rgba(0,0,0,0.6)] hover:shadow-[0_15px_50px_rgba(0,0,0,0.8)] hover:scale-110 active:scale-95 transition-all duration-300 border border-white/10"
                >
                    <Send
                        className={`w-6 h-6 text-white transition-transform duration-500 ${isOpen ? 'rotate-[135deg]' : '-rotate-[15deg] translate-x-0.5'}`}
                        strokeWidth={2.5}
                    />
