    ...
    return (
        <div className="w-full max-w-[440px] mx-auto px-4 z-20 relative">
            ...
            >
                ...
                <button className="w-full bg-white hover:bg-gray-100 text-black font-semibold h-14 rounded-full flex items-center justify-center gap-4 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-lg group">
                ...
                <div className="relative group">
                    ...
                    <div className="relative flex items-center px-2">
                        ...
                        <div className="pl-2 pr-2">
                            <button 
                                type="submit" 
                                className="w-10 h-10 bg-white hover:bg-gray-200 text-black rounded-full flex items-center justify-center transition-all shadow-md active:scale-95"
                            >
