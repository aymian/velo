    ...
    return (
        <div className="w-full max-w-[440px] mx-auto px-4 z-20 relative">
            ...
            >
                ...
                <button
                    onClick={() => { }}
                    className="w-full bg-black hover:bg-neutral-900 text-white font-semibold h-14 rounded-full flex items-center justify-center gap-4 transition-all duration-300 hover:scale-[1.02] active:scale-98 shadow-lg group"
                >
                    <svg
                    ...
                    <span className="text-base tracking-wide">Continue with X</span>
                    </button>

                <button
                    onClick={() => { }}
                    className="w-full bg-[#050708] hover:bg-black text-white font-semibold h-14 rounded-full flex items-center justify-center gap-4 transition-all duration-300 hover:scale-[1.02] active:scale-98 shadow-lg group"
                >
                    <svg
                        className="w-5 h-5 text-white group-hover:text-white transition-colors"
                        viewBox="0 0 24 24"
                    ...
                    <span className="text-base tracking-wide">Continue with Apple</span>
                    </button>

                <button
                    onClick={handleEmailLogin}
                    className="w-full text-white font-semibold h-14 rounded-full flex items-center justify-center gap-4 transition-all duration-300 hover:scale-[1.02] active:scale-98 shadow-lg group bg-[linear-gradient(135deg,#FF2D55,#BF5AF2)] hover:brightness-110"
                >
                    <span className="text-base tracking-wide">Continue with Email</span>
                    </button>
